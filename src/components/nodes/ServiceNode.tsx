...
type ServiceNodeType = Node<NodeData, 'service'>;
...
export default function ServiceNode({
  ...
  return (
    <div
      className={`px-4 py-3 rounded-[10px] border-2 w-[200px] text-sm bg-service border-service-border text-service-text transition-shadow ${
    ...
    >
      ...
      {!compact && hasContent && (
        <>
          <div className="border-t border-service-border opacity-30 mt-2" />
          {data.description && (

...
export default function ServiceNode({
  ...
  return (
    <div
      className={`bg-service text-service-text w-60 rounded-[10px] border-2 px-4 py-3 text-sm transition-shadow ${
        selected
    ...
    >
      ...
      {!compact && hasContent && (
        <>
          <div className="border-service-border mt-2 border-t opacity-30" />
          {data.description && (
